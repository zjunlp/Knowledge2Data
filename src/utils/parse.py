...
prompt_text = "Prompt: "
prompt_text_no_trailing_space = prompt_text.rstrip()
...
def parse_input_without_negative(text=None, no_input=False):
    # no_input: should not request interactive input
    ...
    text_split = text_rem.split(prompt_text_no_trailing_space)
    bg_prompt, prompt = text_split
    ...
    return gen_boxes, bg_prompt, prompt
