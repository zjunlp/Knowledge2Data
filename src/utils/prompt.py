...
# ]
prompts_demo_gpt4 = [
    "A realistic photo of three objects on the table, including a black computer mouse, a black computer keyboard, and a book. The mouse is on the left side of the computer keyboard and is relatively far away from the keyboard, while the book is on the right side of the computer keyboard and not far from the keyboard",
    "A realistic photo of three objects on the table, including a black computer mouse, a black computer keyboard, and a book. The mouse is on the right side of the computer keyboard and is relatively far away from the keyboard, while the book is on the left side of the computer keyboard and not far from the keyboard",
]
...
def ask_llm(prompt):
    key = "sk-8Ps617WoyA3rc4qyzGusVTe37yyC7Qsd3PPDxPS7av8Q0wJK"
...
if __name__ == "__main__":
    ...
    prompts = get_prompts(prompt_type, "gpt-4")
    prompt = prompts[-1]

    prompt_full = templatev0_1.format(prompt=prompt.strip().rstrip("."))
    print(prompt_full)
    print(ask_llm(prompt_full))
