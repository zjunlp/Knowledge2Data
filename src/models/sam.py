...
def load_sam():
    sam_model = SamModel.from_pretrained(os.path.join(os.environ.get("SKG_HF_MODELS"), "sam-vit-base")).to(torch_device)
    sam_processor = SamProcessor.from_pretrained(os.path.join(os.environ.get("SKG_HF_MODELS"), "sam-vit-base"))
